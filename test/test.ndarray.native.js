...
var dzeros = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( dzeros instanceof Error )
};
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( dzeros.length, 4, 'has expected arity' );
	t.end();
});
